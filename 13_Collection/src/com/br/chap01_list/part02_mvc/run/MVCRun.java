...
public class MVCRun {
	...
	public static void main(String[] args) {
		 ...
		 *  			=> 유지보수 용이하다!
		 *  
		 *  - M(Model): 데이터 담당( 데이터들을 담기위한 클래스 (vo), 비즈니스 로직을 처리하기 위한 클래스(service), 데이터 보관함과 연결해서 입출력하는 클래스 (dap)
		 *  - V(View): 화면 담당  즉, 사용자에게 보여지는 시각적인 요소 (출력문(print문), 입력문(Scanner))
		 *  - C(Controller) : 요청처리 담당 (사용자가 요청한 내용을 처리한 후 그 결과를 돌려주는 역할) 출력문 같은거 쓰지않음
		 *  
		 */
