...
public class MusicMenu {
	...
	/**
	 * 메소드가 어떤 역할을 설명하는 주석
	 * 메소드 구역 안에서 alt+shift+j누르면 메소드 상단에 주석생김
	 * 
	 * 3. 특정 곡 삭제시켜주는 서브화면
	 */
	...
	public void updateMusic() {
		...
		System.out.println("수정하고자 하는 곡 명(원본) : ");
		String title = sc.nextLine();
