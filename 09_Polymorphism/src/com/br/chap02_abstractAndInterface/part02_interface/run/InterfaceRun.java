...
public class InterfaceRun {
	...
	//-----------------------------------------------------
		...
		/*
		 * 클래스에서 클래스를 상속받을 때 : 	클래스 extends 클래스(, 클래스 , 클래스<-이거 안됨. 단일상속만 가능   : 화살표 실선
		 
		 * 클래스에서 인터페이스를 구현할때 : 클래스 implements 인터페이스, 인터페이스, ..(다중상속 가능)  	   : 화살표 점선
		 * 
		 * 인터페이스에서 인터페이스를 상속 : 인터페이스 extends 인터페이스, 인터페이스,...(인터페이스 끼리도 다중상속 가능) : 화살표 실선
		 * 
		 * 실선- extends  점선-implements
		 * 
		 *  extends 일반 클래스 - 오버라이딩 필수 x -> extends 추상 클래스 - 강제로 오버라이딩 ->  implements 인터페이스    
		 *  ----------------------------------------------------------------------------------->
		 *                               성이 더 짙어짐( 규약이 더 쎄짐) 
		 */
