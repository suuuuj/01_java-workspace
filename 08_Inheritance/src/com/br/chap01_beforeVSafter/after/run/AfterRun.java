...
public class AfterRun {
 ...
 /*
  *  *상속이란? 자식class extend 부모class
  *  - 부모 자식 간의 구조로 클래스를 구성하는 것으로 
  *  다른 클래스가 가지고 있는 필드및 메소드를 개로 작성할 필요 없이 마치 내것처럼 사용할 수 있음
  *  
  *  *상속의 장점
  *  -공통적인 코드들을 부모 클래스로 한번 정의해두면
  *  새로운 클래스 작성시 보다 적은 양의 코드로 작성 가능
  *  
  *   -중복된 코드를 별도로 관리하기 때문에 코드의 추가나 변경에 용이하다
