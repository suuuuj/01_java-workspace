...
public class F_Triple {
	 ...
	 *  
	 *  [표현법] 
	 *   조건식 ? 조건식이 true 일 경우 돌려줄 결과값 : 조건식이 false일 경우 돌려줄 결과값 
	 *     
	 *   조건식 -> 반드시 true/false 가 나오도록 작성
	...
	public void method1() {
		...
		// 만약 돌려줄 값이 정수라면  int result = num > 0 ? 10 : 20;
		
		// 사용자가 입력한 xx은(는) xxxxxx이다.
	...
	public void method4() {
		// 사용자가 입력한 정수값이 양수인지, 음수인지, 0인지 정확하게 판별한 후 출력
		...
		System.out.printf("사용자가 입력한 %d는(은) %s", num, result);  // 사용자가 입력한 4556는 양수다.
		System.out.printf("\n" + result);   // 양수다.
	...
	public void method5() {
		...
		// 자료형이 일치하지 않음                             숫자 -> 문자열화   문자열덧셈연산을 하면 하나의 문자열화!       
