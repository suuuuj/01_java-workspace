...
public class ExMenu {
	...
	public void deleteProduct() {
		...
		System.out.print("삭제하고자 하는 제품명 : ");
		String name = sc.nextLine();
		
		// 삭제하고자 하는 제품의 브랜드명 입력받기 (String brand 변수에 기록)
		
		System.out.print("삭제하고자 하는 브랜드명 : ");
		String brand = sc.nextLine();
	...
	public void searchProduct() {
		...
		ArrayList<Product> search = ec.searchProduct(nameKeyword);
	...
	public void selectPrice() {
		...
		System.out.print("검색하고자 하는 브랜드명 : ");
		String brand = sc.nextLine();
		
		// ec의 selectPrice메소드 호출시 위의 입력값 전달하면서 호출하고 이때 돌아오는 가격값 받기
		int sPrice = ec.selectPrice(name,brand);
		...
		if(sPrice == 0) {
			...
			System.out.printf("%s 브랜드의 %s 제품의 가격은 %d원입니다.", brand,name,sPrice);
		}
	}
